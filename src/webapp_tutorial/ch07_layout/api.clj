(ns webapp-tutorial.ch07-layout.api
  "A ns containing business/API logic for the application. Notes regarding this ns:
   * There is no need for all logic to reside in this ns. It it grows too large, create an api
   package and put your logic nses in there or bring in your logic from another lib.
   * It is critical to never put any web logic here. That is a transport mechanism and your
   api should know nothing about the transport layer."
